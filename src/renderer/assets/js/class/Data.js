class Data {
    ...
    append() {
        ...
        el.innerHTML = `
            <div class="clipboard-tile group relative bg-card text-card-foreground border border-border rounded-xl p-5 transition-all shadow-sm overflow-hidden">
                <div class="flex items-center gap-2 mb-2">
                    <span class="content-type text-[9px] px-1.5 py-0.5 rounded bg-muted text-muted-foreground uppercase font-bold tracking-wider"></span>
                </div>
                <div class="flex justify-between items-start mb-2 gap-4">
                    <div class="flex-1 min-w-0">
                        <pre class="text-sm text-foreground whitespace-pre-wrap break-all overflow-hidden value"></pre>
                    </div>
                    <div class="tile-actions opacity-0 group-hover:opacity-100 transition-opacity flex gap-2 no-drag shrink-0 absolute top-0 right-0 p-5 rounded-xl">
                        <button class="copy p-2 bg-primary/10 hover:bg-primary text-primary hover:text-primary-foreground rounded-lg h-10 w-10 flex items-center justify-center">
                        ...
                        <button class="delete p-2 bg-destructive/10 hover:bg-destructive text-destructive hover:text-destructive-foreground rounded-lg h-10 w-10 flex items-center justify-center">
                            <span class="material-icons-outlined">delete</span>
                        </button>
                    </div>
                </div>
                <div class="text-right">
                    <span class="text-[10px] font-medium text-muted-foreground uppercase createdAt"></span>
                </div>
            </div>
        `;
